...
def find_js_function_declarations(file_path):
    keys = {}
...
def main2():
    ...
    jsp_sub_folders = ['common', 'mailbox', 'eaccess', 'fields']
    js_root_path = os.path.join(root_path, 'src', 'main', 'webapp', 'js')
